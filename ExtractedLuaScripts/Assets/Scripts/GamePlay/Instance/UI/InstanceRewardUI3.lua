...
local InstanceRewardUI3 = GameTableDefine.InstanceRewardUI3
...
function InstanceRewardUI3:GetView()
    self.m_view = GameUIManager:SafeOpenUI(ENUM_GAME_UITYPE.INSTANCE_REWARD_UI_3, self.m_view, require("GamePlay.Instance.UI.InstanceRewardUIView3"), self, self.CloseView)
    return self.m_view
end

function InstanceRewardUI3:GetUIModel()
...
function InstanceRewardUI3:CloseView()
    GameUIManager:CloseUI(ENUM_GAME_UITYPE.INSTANCE_REWARD_UI_3)
    self.m_view = nil
