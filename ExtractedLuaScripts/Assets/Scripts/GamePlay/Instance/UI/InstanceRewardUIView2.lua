...
local UI = GameTableDefine.InstanceRewardUI2
local InstanceRewardUIView2 = Class("InstanceRewardUIView2", UIView)


function InstanceRewardUIView2:ctor()
    self.super:ctor()
...
function InstanceRewardUIView2:OnEnter()
...
function InstanceRewardUIView2:InitView()
...
function InstanceRewardUIView2:SetRewardInfo()
...
function InstanceRewardUIView2:ShowAchievements()
    self.m_openingBtn.interactable = false
    self.m_tipGO:SetActive(false)
...
function InstanceRewardUIView2:OpenAllRewardList()
...
function InstanceRewardUIView2:OpenAEgg(isPre)
...
function InstanceRewardUIView2:OnExit()
    if self.tiemr then
