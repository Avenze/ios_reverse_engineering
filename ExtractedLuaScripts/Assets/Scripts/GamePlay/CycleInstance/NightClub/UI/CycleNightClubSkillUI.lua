...
function CycleNightClubSkillUI:GetView()
    CycleNightClubModel = GameTableDefine.CycleInstanceDataManager:GetCurrentModel()
    self:GetUIModel()
    self.m_view = GameUIManager:SafeOpenUI(ENUM_GAME_UITYPE.CYCLE_NIGHT_CLUB_SKILL_UI, self.m_view, require("GamePlay.CycleInstance.NightClub.UI.CycleNightClubSkillUIView"), self, self.CloseView)
    return self.m_view
end

function CycleNightClubSkillUI:CloseView()
    GameUIManager:CloseUI(ENUM_GAME_UITYPE.CYCLE_NIGHT_CLUB_SKILL_UI)
    self.m_view = nil
...
function CycleNightClubSkillUI:GetUIModel()
...
function CycleNightClubSkillUI:RefreshUIModel()
    self:GetUIModel()
end

function CycleNightClubSkillUI:ShowSkillPanel()
    self:GetView():Invoke("ShowSkillPanel", CycleNightClubModel:GetCurSkillData())
end

function CycleNightClubSkillUI:GetCurSkillItemCfg(skillID)
...
function CycleNightClubSkillUI:GetNextSkillItemCfg(skillID)
