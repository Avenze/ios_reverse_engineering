...
local CycleNightClubUnlockUIView = Class("CycleNightClubUnlockUIView", UIView)

function CycleNightClubUnlockUIView:ctor()
    self.super:ctor()
    self.m_data = {}
    self.m_roomID = nil
end

function CycleNightClubUnlockUIView:OnEnter()
...
function CycleNightClubUnlockUIView:OnExit()
...
function CycleNightClubUnlockUIView:InitView(id)
...
return CycleNightClubUnlockUIView