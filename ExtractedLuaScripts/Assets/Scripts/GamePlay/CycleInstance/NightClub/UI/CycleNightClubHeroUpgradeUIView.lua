...
---@class CycleNightClubHeroUpgradeUIView:UIBaseView
local CycleNightClubHeroUpgradeUIView = Class("CycleNightClubHeroUpgradeUIView",UIBaseView)
---@type SlotMachineUI
...
function CycleNightClubHeroUpgradeUIView:ctor()
...
function CycleNightClubHeroUpgradeUIView:OnEnter()
...
---@param heroID
function CycleNightClubHeroUpgradeUIView:Init(heroID)
    self:InitWithHeroID(heroID)
    self:RefreshTitle()
end

---Title
function CycleNightClubHeroUpgradeUIView:RefreshTitle()
    local heroConfig = self.m_heroConfig
    local haveRes = CycleNightClubModel:GetCurHeroExpRes()
    local haveResShow = CycleNightClubModel:GetCurHeroExpResShow()
...
---HeroBaseInfo
function CycleNightClubHeroUpgradeUIView:RefreshHeroBaseInfo()
    local heroConfig = self.m_heroConfig
...
---HeroLevelInfo
function CycleNightClubHeroUpgradeUIView:RefreshHeroLevelInfo()
    local heroConfig = self.m_heroConfig
...
---用对应英雄ID初始化界面
function CycleNightClubHeroUpgradeUIView:InitWithHeroID(heroID)
...
---升级按钮
function CycleNightClubHeroUpgradeUIView:OnUpgradeButtonClick(showResNotEnoughTip)
...
function CycleNightClubHeroUpgradeUIView:OnExit()
...
return CycleNightClubHeroUpgradeUIView