...
---@class CycleNightClubOfflineRewardUI
local CycleNightClubOfflineRewardUI = GameTableDefine.CycleNightClubOfflineRewardUI

local GameUIManager = GameTableDefine.GameUIManager
local ConfigMgr = GameTableDefine.ConfigMgr

function CycleNightClubOfflineRewardUI:GetView()
    ...
    self.timer = GameTimer:CreateNewTimer(1, function()
        if GameUIManager:UIIsOnTop(ENUM_GAME_UITYPE.CYCLE_NIGHT_CLUB_MAIN_VIEW_UI, true, {
            ...
            ENUM_GAME_UITYPE.CYCLE_NIGHT_CLUB_CUT_SCREEN_UI,
        }) then
            self.m_view = GameUIManager:SafeOpenUI(ENUM_GAME_UITYPE.CYCLE_NIGHT_CLUB_OFFLINE_REWARD_UI, self.m_view, require("GamePlay/CycleInstance/NightClub/UI/CycleNightClubOfflineRewardUIView"), self, self.CloseView)
...
function CycleNightClubOfflineRewardUI:CloseView()
    GameUIManager:CloseUI(ENUM_GAME_UITYPE.CYCLE_NIGHT_CLUB_OFFLINE_REWARD_UI)
    self.m_view = nil
