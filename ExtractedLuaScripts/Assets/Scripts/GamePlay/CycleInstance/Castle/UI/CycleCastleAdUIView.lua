...
local CycleCastleAdUIView = Class("CycleCastleAdUIView", UIView)

function CycleCastleAdUIView:ctor()
    self.super:ctor()
    self.m_data = {}
end

function CycleCastleAdUIView:OnEnter()
    if GameTableDefine.CycleInstanceDataManager:GetCurrentModel().instance_id == 5 then
        UI = GameTableDefine.CycleCastleAdUI
    end
    ...
    self:SetButtonClickHandler(adBtn,function()
        UI:ClaimResource(function()
            ...
            GameTableDefine.CycleCastleMainViewUI:SetEventIAAActive(false)
...
function CycleCastleAdUIView:ShowView()
    -- 显示资源item
...
function CycleCastleAdUIView:OnExit()
	self.super:OnExit(self)
end

return CycleCastleAdUIView