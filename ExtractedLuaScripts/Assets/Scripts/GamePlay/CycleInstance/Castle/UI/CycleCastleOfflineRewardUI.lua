...
---@class CycleCastleOfflineRewardUI
local CycleCastleOfflineRewardUI = GameTableDefine.CycleCastleOfflineRewardUI

local GameUIManager = GameTableDefine.GameUIManager
local ConfigMgr = GameTableDefine.ConfigMgr

function CycleCastleOfflineRewardUI:GetView()
    ...
    self.timer = GameTimer:CreateNewTimer(1, function()
        if GameUIManager:UIIsOnTop(ENUM_GAME_UITYPE.CYCLE_CASTLE_MAIN_VIEW_UI, true, {
            ...
            self.m_view = GameUIManager:SafeOpenUI(ENUM_GAME_UITYPE.CYCLE_CASTLE_OFFLINE_REWARD_UI, self.m_view, require("GamePlay/CycleInstance/Castle/UI/CycleCastleOfflineRewardUIView"), self, self.CloseView)
...
function CycleCastleOfflineRewardUI:CloseView()
    GameUIManager:CloseUI(ENUM_GAME_UITYPE.CYCLE_CASTLE_OFFLINE_REWARD_UI)
    self.m_view = nil
