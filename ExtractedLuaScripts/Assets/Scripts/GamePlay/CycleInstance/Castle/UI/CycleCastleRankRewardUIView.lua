...
local UI = GameTableDefine.CycleCastleRankRewardUI
local CycleCastleRankRewardUIView = Class("CycleCastleRankRewardUIView", UIView)


function CycleCastleRankRewardUIView:ctor()
    self.super:ctor()
...
function CycleCastleRankRewardUIView:OnEnter()
...
function CycleCastleRankRewardUIView:getTableCount(t)
    local num = 0
...
function CycleCastleRankRewardUIView:InitView()
...
function CycleCastleRankRewardUIView:SetRewardInfo()
...
function CycleCastleRankRewardUIView:ShowAchievements()
    self.m_openingBtn.interactable = false
    self.m_tipGO:SetActive(false)
...
function CycleCastleRankRewardUIView:OpenAllRewardList()
...
function CycleCastleRankRewardUIView:OpenAEgg(isPre)
...
function CycleCastleRankRewardUIView:OnExit()
    if self.tiemr then
...
return CycleCastleRankRewardUIView