...
---@class CycleToyHeroUpgradeUIView:UIBaseView
local CycleToyHeroUpgradeUIView = Class("CycleToyHeroUpgradeUIView",UIBaseView)
---@type SlotMachineUI
...
function CycleToyHeroUpgradeUIView:ctor()
...
function CycleToyHeroUpgradeUIView:OnEnter()
...
---@param heroID
function CycleToyHeroUpgradeUIView:Init(heroID)
    self:InitWithHeroID(heroID)
    self:RefreshTitle()
end

---Title
function CycleToyHeroUpgradeUIView:RefreshTitle()
    local heroConfig = self.m_heroConfig
    local haveRes = CycleToyModel:GetCurHeroExpRes()
    local haveResShow = CycleToyModel:GetCurHeroExpResShow()
...
---HeroBaseInfo
function CycleToyHeroUpgradeUIView:RefreshHeroBaseInfo()
    local heroConfig = self.m_heroConfig
...
---HeroLevelInfo
function CycleToyHeroUpgradeUIView:RefreshHeroLevelInfo()
    local heroConfig = self.m_heroConfig
...
---用对应英雄ID初始化界面
function CycleToyHeroUpgradeUIView:InitWithHeroID(heroID)
...
---升级按钮
function CycleToyHeroUpgradeUIView:OnUpgradeButtonClick(showResNotEnoughTip)
...
function CycleToyHeroUpgradeUIView:OnExit()
...
return CycleToyHeroUpgradeUIView