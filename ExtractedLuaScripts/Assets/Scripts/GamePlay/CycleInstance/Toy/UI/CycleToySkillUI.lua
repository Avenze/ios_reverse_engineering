...
function CycleToySkillUI:GetView()
    CycleToyModel = GameTableDefine.CycleInstanceDataManager:GetCurrentModel()
    self:GetUIModel()
    self.m_view = GameUIManager:SafeOpenUI(ENUM_GAME_UITYPE.CYCLE_TOY_SKILL_UI, self.m_view, require("GamePlay.CycleInstance.Toy.UI.CycleToySkillUIView"), self, self.CloseView)
    return self.m_view
end

function CycleToySkillUI:CloseView()
    GameUIManager:CloseUI(ENUM_GAME_UITYPE.CYCLE_TOY_SKILL_UI)
    self.m_view = nil
...
function CycleToySkillUI:GetUIModel()
...
function CycleToySkillUI:RefreshUIModel()
    self:GetUIModel()
end

function CycleToySkillUI:ShowSkillPanel()
    self:GetView():Invoke("ShowSkillPanel", CycleToyModel:GetCurSkillData())
end

function CycleToySkillUI:GetCurSkillItemCfg(skillID)
...
function CycleToySkillUI:GetNextSkillItemCfg(skillID)
