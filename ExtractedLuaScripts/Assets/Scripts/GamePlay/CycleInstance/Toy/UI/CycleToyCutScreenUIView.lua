...
local CycleToyCutScreenUIView = Class("CycleToyCutScreenUIView", UIView)

function CycleToyCutScreenUIView:ctor()
    self.super:ctor()
end

function CycleToyCutScreenUIView:OnEnter()
    self.m_anim = self.m_uiObj:GetComponent("Animation")
    self.m_record = {}
end

function CycleToyCutScreenUIView:OnExit()
    self.super:OnExit(self)
end

function CycleToyCutScreenUIView:Play(cb, spend)
...
return CycleToyCutScreenUIView