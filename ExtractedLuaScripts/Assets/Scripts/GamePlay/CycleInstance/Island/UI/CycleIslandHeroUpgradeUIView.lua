...
---@class CycleIslandHeroUpgradeUIView:UIBaseView
local CycleIslandHeroUpgradeUIView = Class("CycleIslandHeroUpgradeUIView",UIBaseView)
---@type SlotMachineUI
...
function CycleIslandHeroUpgradeUIView:ctor()
...
function CycleIslandHeroUpgradeUIView:OnEnter()
...
---@param heroID
function CycleIslandHeroUpgradeUIView:Init(heroID)
    self:InitWithHeroID(heroID)
    self:RefreshTitle()
end

---Title
function CycleIslandHeroUpgradeUIView:RefreshTitle()
    local heroConfig = self.m_heroConfig
    local currentModel = CycleInstanceDataManager:GetCurrentModel()
    local haveRes = currentModel:GetCurHeroExpRes()
    local haveResShow = currentModel:GetCurHeroExpResShow()
...
---HeroBaseInfo
function CycleIslandHeroUpgradeUIView:RefreshHeroBaseInfo()
    local heroConfig = self.m_heroConfig
    ...
    local currentModel = CycleInstanceDataManager:GetCurrentModel()
    local roomConfig = currentModel.roomsConfig[heroConfig.room_id]
    local productionID = roomConfig.production
    local productConfig = currentModel.resourceConfig[productionID]
...
---HeroLevelInfo
function CycleIslandHeroUpgradeUIView:RefreshHeroLevelInfo()
    local heroConfig = self.m_heroConfig
...
---用对应英雄ID初始化界面
function CycleIslandHeroUpgradeUIView:InitWithHeroID(heroID)
...
---升级按钮
function CycleIslandHeroUpgradeUIView:OnUpgradeButtonClick(showResNotEnoughTip)
...
function CycleIslandHeroUpgradeUIView:OnExit()
...
return CycleIslandHeroUpgradeUIView