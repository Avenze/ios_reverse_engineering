...
---@class CycleInstanceWorkerRunToWorkSeat:AIStateBase
---@field m_owner CycleInstanceWorkerClass
local CycleInstanceWorkerRunToWorkSeat = Class("CycleInstanceWorkerRunToWorkSeat",AIStateBase)

function CycleInstanceWorkerRunToWorkSeat:ctor()
    self.m_timerID = nil
    self.m_speed = nil
end

function CycleInstanceWorkerRunToWorkSeat:OnEnter(...)
    ...
    actor:CalculatePath(
            ...
            function()
                actor:TryTransState(
                        function()
                            stateMachine:ChangeState(ActorDefine.CycleInstanceState.CycleInstanceWorkerWaklToWorkPos)
                        end
                )
            end
    )
...
function CycleInstanceWorkerRunToWorkSeat:OnExit()

end

return CycleInstanceWorkerRunToWorkSeat