...
local CutScreenUIView = Class("CutScreenUIView", UIView)

function CutScreenUIView:ctor()
    self.super:ctor()
end

function CutScreenUIView:OnEnter()
    self.m_anim = self.m_uiObj:GetComponent("Animation")
    self.m_record = {}
end

function CutScreenUIView:OnExit()
    self.super:OnExit(self)
end

function CutScreenUIView:Play(cb, spend)
